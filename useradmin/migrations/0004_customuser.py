...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('useradmin', '0003_roletype_alter_useradminmodel_role'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='useradmin.roletype', verbose_name='usertype')),
            ],
            options={
